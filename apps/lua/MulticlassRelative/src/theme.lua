...
Theme.palettes = {
  dark = {
    ...
    lapper = rgbm(0xD8 / 255, 0x4B / 255, 0x3E / 255, 1),
    lapped = rgbm(0x2A / 255, 0xA6 / 255, 0xA2 / 255, 1),
  ...
  light = {
    ...
    lapper = rgbm(0xAD / 255, 0x29 / 255, 0x22 / 255, 1),
    lapped = rgbm(0x0B / 255, 0x72 / 255, 0x70 / 255, 1),
